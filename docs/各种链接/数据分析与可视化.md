...
原本的plotly express现已合入plotly v4，可以通过模块名plotly.express引用。  
jupyterlab到v3.0为止，还需要安装插件才能正常显示
...
## matplotlib自带配色表：  
https://matplotlib.org/tutorials/colors/colormaps.html#colorcet
